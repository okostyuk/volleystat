...
import com.oleg.volleystat.R.id;
import com.oleg.volleystat.R.layout;
import com.oleg.volleystat.R.string;
			...
			public void onClick(View v) {
				if (isTeamReady){
					...
					if (gamePlayersList.size() == 6){
						...
						applyTeamButton.setText("TODO TODO");
						isTeamReady = true;*/
						...
						startGameButton.setEnabled(false);
						Toast.makeText(PositionsActivity.this, "TODO TODO 6 TODO", Toast.LENGTH_SHORT).show();
					}
				}
			}
		});
