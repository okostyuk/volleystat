...
import com.oleg.volleystat.ActionType;
import com.oleg.volleystat.Game;
import com.oleg.volleystat.Player;
import com.oleg.volleystat.Stat;
import com.oleg.volleystat.Action;
import com.oleg.volleystat.StatType;
import com.oleg.volleystat.StatValue;
...
public class GameActivity extends OrmLiteBaseActivity<DatabaseHelper>  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        playersList.setOnItemLongClickListener(new OnItemLongClickListener() {
			public boolean onItemLongClick(AdapterView<?> adapter, View view, int index, long id) {
	    		...
	    		builder.setTitle(getResources().getString(R.string.replace) + selectedPlayer.getName() + " :");
    ...
    private class PlayersAdapter extends BaseAdapter{
    	final CharSequence[] putItems = {"TODO", "TODO TODO TODO", "TODO"};
    	final CharSequence[] attackItems = {"TODO", "TODO TODO TODO", "TODO"};
    	final CharSequence[] blockItems = {"TODO", "TODO TODO TODO", "TODO"};
    	final CharSequence[] errorItems = {"TODO", "TODO"};
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			putButton.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					builder.setTitle("TODO " + player.getName());
